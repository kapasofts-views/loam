    ...
    <?php endif; ?>
            ...
            <div class="row" id="portfolio">
                ...
                foreach($photos as $key => $photo){
                    print '<div class="span6 portfolio_item block" data-filter="">';
                    print '<div class="view view-first nolink ">';
                    print '    <a href="' . $photo . '" rel="prettyPhoto"><img src="' . $photo . '" alt="" /></a>';
                    print '    <div class="mask">';
                    print '        <a href="' . $photo . '" rel="prettyPhoto" title="Image Title here" class="info"></a>';
                    print '    </div>';
                    print '</div>';
                    print '</div>';
                }
