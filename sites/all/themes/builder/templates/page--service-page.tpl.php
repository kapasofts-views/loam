    ...
    <?php endif; ?>
        ...
        <div class="row mrgbtm35">
            <div class="span6">
                <div class="row-fluid">
                    <div class="span12">
                        <?php print '<h3>' . $primary_title . '</h3>';?>
                        <?php print '<img src="'.$primary_photo.'" alt="" align="left" width="300" height="207" style="margin-right:20px"/>';?>
                        <?php
                        foreach($primary_content as $key => $par){
                            print '<p>'.$par.'</p>';
                        }
                        ?>
                    </div>
            ...
            <div class="span6">
                <div class="row-fluid">
                    <div class="span12">
                        <?php print '<h3>' .$secondary_title. '</h3>';?>
                        <?php print '<img src="'.$secondary_photo.'" alt="" align="right" width="300" height="207" style="margin-left:20px"/>';?>
                       <?php
                        foreach($secondary_content as $key=>$par){
                            print '<p>'.$par.'</p>';
                        }
                       ?>
                    </div>
