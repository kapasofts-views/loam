...
<div class="main_content_area">
    <div class="container">
        ...
        <div class="row mrgbtm35">
            <div class="span6">
                <?php print render($page['row_three_top_left']); ?>
                <div class="home_separator"></div>
                <?php print render($page['row_three_bottom_left']); ?>
            </div><!--end of Span6-->
            <div class="span6">
                <?php print render($page['row_three_full_right']); ?>
            </div>
        </div>
        ...
        <?php if(!empty($page['row_second'])) {print '<div class="home_separator"></div>';}?>
